function R = construct_dsgmat(subj_num, glm)
...
if isfolder('/Volumes/Diedrichsen_data$/data/SeqSpatialSupp_fMRI')
    workdir='/Volumes/Diedrichsen_data$/data/SeqSpatialSupp_fMRI';
% After mounting the diedrichsen datashare on the CBS server.
elseif isfolder('/srv/diedrichsen/data/SeqSpatialSupp_fMRI')
