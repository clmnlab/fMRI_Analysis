...
case 'HRF:fit' % finding optimal parameters for hrf
    ...
    load SPM;     
    load(fullfile(baseDir, roiDir, sprintf('%your_ROI.mat', sprintf('S%02d', s)))); % Load your ROI file
    ...
    F.p_opt = p_opt;
    save(fullfile(baseDir, roiDir, sprintf('%s_hrf_ROI_timeseries_glm%d.mat', sprintf('S%02d', s), glm)), 'F');
